...
import com.farms.krushisanjivini.databinding.ActivityComplaintRegistrationBinding
import com.farms.krushisanjivini.network.ApiClient
import com.farms.krushisanjivini.network.ApiServiceInterface
import com.farms.krushisanjivini.ui.questions.MyQuestionListingActivity
...
class ComplaintRegistrationActivity : AppCompatActivity() {
    ...
    private var isAllFieldFilled :Boolean =false
        ...
        binding.submitButton.setOnClickListener {
            ...
            if(networkStatus){
                ...
                registerCompliant()
                    ...
                    if(userLanguageID==2){
                        showAlertDialog("ದಯವಿಟ್ಟು ಎಲ್ಲಾ ಕ್ಷೇತ್ರಗಳನ್ನು ಆಯ್ಕೆಮಾಡಿ")
                    }else{
        ...
        mApiService!!.registerQuestion(1,"1",currentDateTime!!,questionText,imageUrl!!,audioUrl,"","New")
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                if(response.code()==200 ||response.code()==201|| response.code()==202){
                    ...
                    if(userLanguageID==2) showSuccessDialog("ನಿಮ್ಮ ವಿನಂತಿಯನ್ನು ಯಶಸ್ವಿಯಾಗಿ ನೋಂದಾಯಿಸಲಾಗಿದೆ!!")
                    else showSuccessDialog("Your request has been registered successfully!!")
    ...
    private fun capturePhoto(){
        ...
        mUri = if(Build.VERSION.SDK_INT >= 24){
            FileProvider.getUriForFile(this, "com.farms.krushisanjivini.fileprovider",
                capturedImage)
        } else {
