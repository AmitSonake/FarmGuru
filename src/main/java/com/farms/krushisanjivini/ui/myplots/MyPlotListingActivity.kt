...
import com.farms.krushisanjivini.adapters.spinners.PlotListAdapter
...
class MyPlotListingActivity : AppCompatActivity() {
            ...
            mApiService!!.getPlotRegistered(userLanguageID).enqueue(object:
                ...
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    if(response.code()==200||response.code()==201|| response.code()==202){
                        ...
                        CheckInternetConnection.showSessionTimeOutDialog("User login session expired!!.",this@MyPlotListingActivity)
                    }else{
