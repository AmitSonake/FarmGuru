...
import com.farms.krushisanjivini.adapters.DiaryPlotListAdapter
...
class DiaryPlotListingActivity : AppCompatActivity() {
                ...
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    if(response.code()==200||response.code()==201|| response.code()==202){
                        ...
                        if(plotParsedList.size>0){
                            binding.plotsListRecyclerView.adapter = DiaryPlotListAdapter(plotParsedList,languageCode)
                        }else{
                            if(userLanguageID==2){
                        ...
                        CheckInternetConnection.showSessionTimeOutDialog("User login session expired!!.",this@DiaryPlotListingActivity)
                    }else{
