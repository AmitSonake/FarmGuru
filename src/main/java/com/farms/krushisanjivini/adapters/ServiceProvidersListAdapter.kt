...
class ServiceProvidersListAdapter(private val providersList: MutableList<ServiceProviders>, private var userLanguage:String?)
    : RecyclerView.Adapter<ServiceProvidersListAdapter.ViewHolder>() {
