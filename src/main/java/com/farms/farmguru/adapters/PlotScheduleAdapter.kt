...
import com.farms.farmguru.databinding.SelectCropItemBinding
import com.farms.farmguru.model.CropResponse
import com.farms.farmguru.schedule.MyScheduleActivity


class PlotScheduleAdapter(private val crops: MutableList<CropResponse>)
    : RecyclerView.Adapter<PlotScheduleAdapter.ViewHolder>() {
